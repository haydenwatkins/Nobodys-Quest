...
registerMap({
  ...
  tiles: [
    ...
    "#fffRffffffffffffRffffRfffRff#",
    "#ffffRffffffffffffRf2ffffffff#",
    "#ffffffcffffffff3ffffffffffff#",
    "#ffffffffffffffffffffffffffff#",
    "#ffffRRRffRRRRffRRRffffffffff#",
    "#ffffffffffffffffffffffffffff#",
    "#ffffffffffffffffffffffffffff#",
    "xfffmfff5ffff8ffffHfffffNffff#",
    "#ffffffffffffffffffffffffffff#",
    "#ffffffffffffffffffffffffffff#",
    "#ffffRRRffRRRRffRRRffffffffff#",
    "#ffffffffffffffffffffffffffff#",
    "#ffffffffffafffffff5fffffffff#",
    "#ffffRff2fffffffffRffffffffff#",
    "#fffRffffffffffffffRffRfffRff#",
    "#ffffffffffffffffffffffffffff#",
    "##############################",
  ],
});
...
registerMap({
  ...
  legend: {
    ...
    "5": { tile: "floor", enemy: "brute" },
    "8": { tile: "floor", enemy: "shade" },
    "s": { tile: "floor", message: "THE OBSERVATORY: Restore Dawn in the northwest, Dusk in the northeast, and Midnight in the southeast. Then return to the star instrument at the south end of the central hall. The watchkeepers still wear their colored wards." },
    "m": { tile: "floor", message: "The astronomers spun starlight into a thread to guide lost travelers. Three lenses must look home before the instrument can weave again." },
    "x": { tile: "floor", portal: { map: "overworld", x: 90, y: 78 }, portalStyle: "gap", seamless: true },
    "H": { tile: "floor", chest: { heal: true, name: "an astronomer’s mooncake" } },
    "R": { tile: "rock", on: "floor" },
  },
  ...
  tiles: [
    ...
    "#ffffffffffffffffffffffffffff#",
    "#ffffffffffffffffffffffffffff#",
    "#ffRfffRff#fffsffff#ffRfffRff#",
    "#fffffffff#ffffffff#fffffffff#",
    "#fffffff2f#ffffffff#ff3ffffff#",
    "#fffffffff#ffffffff#fffffffff#",
    "#ffff4ffffffffffffffffff8ffff#",
    "#ffffffffffff3fffffffffffffff#",
    "#ffffffffffffffff2fffffffffff#",
    "#####ff#######fff#######ff####",
    "#fffffffff#ffffffff#fffffffff#",
    "#fffffffff#fRfffffR#ffff5ffff#",
    "#ffffffffffffffmfffffffffffff#",
    "#ffffHffffffffffffffffffff4ff#",
    "#ffRfffRff#ffffffff#fffffffff#",
    "#fffffffff#ffffffff#ffRfffRff#",
    "#ffffffffffffffffffffffffffff#",
    "##############################",
  ],
});
...
registerMap({
  ...
  legend: {
    ...
    "s": { tile: "grass", message: "A seed still sleeps in the southeast clearing. Carry it to the old stump in the southwest and the grove may remember its way home. The root curtain has a northern passage." },
    "m": { tile: "grass", message: "The oldest tree sheltered travelers here. Its roots still reach across the grove. Bring the Whispering Seed to the stump west of this sign." },
    "2": { tile: "grass", enemy: "bat" },
    "3": { tile: "grass", enemy: "bones" },
  ...
  tiles: [
    ...
    "t..wwww.......t.....pp.6.....t",
    "t.............t.....pp.......t",
    "t....ppppppppptpp3pppppppp...t",
    "t....ppppppppptppppppppppp...t",
    "t...Cp..6.....t..............t",
    "t....p........t....wwww..7...t",
    "t....p........t....wwww......t",
    "t....p.m......t....wwww......t",
